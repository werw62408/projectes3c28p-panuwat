...
extern bool g_simTouch; extern int g_simTouchX, g_simTouchY;
class LGFX_ES3C28P : public LGFX_Sprite {
 ...
 public:
  ...
  int getTouch(lgfx::touch_point_t* tp, int = 1) { if (!g_simTouch) return 0; tp->x = g_simTouchX; tp->y = g_simTouchY; return 1; }   // a finger, set by tests
