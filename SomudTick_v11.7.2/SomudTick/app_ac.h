...
//  v11.4: the pin gives its strongest current (about 40 mA instead of 20). v11.5: each setting is sent once
//  (the owner found the strong pin enough). For more range: an NPN transistor (S8050 / 2N2222) between the pin
//  and the LED (see README).
